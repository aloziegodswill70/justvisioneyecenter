      ...
      >
        ...
        >
          <svg
            ...
            fill="white"
          >
            <path d="M16 .4C7.3.4.4 7.3.4 16c0 2.8.7 5.6 2.1 8L0 32l8.3-2.2c2.3 1.3 4.9 2 7.7 2 8.7 0 15.6-6.9 15.6-15.6S24.7.4 16 .4zm0 28.5c-2.4 0-4.7-.6-6.7-1.8l-.5-.3-4.9 1.3 1.3-4.8-.3-.5c-1.2-2-1.8-4.3-1.8-6.7 0-7 5.7-12.7 12.7-12.7S28.7 9 28.7 16 23 28.9 16 28.9zm7-9.5c-.4-.2-2.4-1.2-2.7-1.3-.4-.2-.6-.2-.9.2-.3.4-1 1.3-1.3 1.6-.2.2-.4.3-.8.1-.4-.2-1.6-.6-3-1.9-1.1-1-1.9-2.2-2.1-2.6-.2-.4 0-.6.2-.8.2-.2.4-.4.6-.6.2-.2.3-.4.4-.7.1-.2 0-.5 0-.7s-.9-2.2-1.2-3c-.3-.7-.6-.6-.9-.6h-.8c-.3 0-.7.1-1 .5-.3.4-1.3 1.3-1.3 3.2 0 1.9 1.4 3.8 1.6 4 .2.3 2.8 4.2 6.8 5.9 1 .4 1.8.7 2.4.9 1 .3 1.9.2 2.6.1.8-.1 2.4-1 2.8-2 .3-1 .3-1.8.2-2-.1-.2-.3-.3-.7-.5z" />
          </svg>
        </motion.div>
      </a>
    </motion.div>
